...
subsets = [
    ('Benign', 'Benign_mask'),
    ('Malignant', 'Malignant_mask')
]

base_input_dir = r'C:/Users/1/Desktop/master_degree/DATA/UDIAT'
base_output_dir = r'C:/Users/1/Desktop/master_degree/DATA/UDIAT_AUG'
num_aug_per_image = 5
...
for img_folder, mask_folder in subsets:
    ...
    image_paths = sorted(glob(os.path.join(img_in_dir, '*.png')))
    ...
    for img_path in tqdm(image_paths):
        ...
        for i in range(num_aug_per_image):
            ...
            aug_fname = f"{base_name}_aug{i}.png"
